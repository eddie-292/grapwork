...
本文档详细说明 GrapWork 项目的构建流程、环境要求和打包配置。
...
输出文件：
- `release/GrapWork-{version}.dmg`
- `release/GrapWork-{version}-mac.zip`
...
输出文件：
- `release/GrapWork Setup {version}.exe`
- `release/GrapWork-{version}-win.zip`
...
输出文件：
- `release/GrapWork-{version}.AppImage`
